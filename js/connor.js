...
//variables
  ...
  //functions
    ...
    function connor() {
      ...
      //update skills here
      var skills = "<ul><li>HTML5, CSS, JavaScript, jQuery</li> <li>PHP, Apache + MySQL</li> <li>Java Development</li> <li>Adobe Premiere & After Effects</li> <li>Photoshop & Illustrator</li> <li>Git and Linux</li></ul>";
